...
mui.plusReady(function () {
    var settings = __WEBPACK_IMPORTED_MODULE_0_assets_js_appp_js__["a" /* app */].getSettings();
    ...
    regButton.addEventListener('tap', function (event) {
        ...
        /* 验证表单提交数据*/
        __WEBPACK_IMPORTED_MODULE_0_assets_js_appp_js__["a" /* app */].reg(regInfo, function (err) {
            /*如果有错误提示用户错误信息 如果是用户已经注册过 设置用户登录信息为空后 跳转到登录页面*/
            if (err) {
                /*如果用户返回的信息是20204 设置注册信息为空*/
                if (err == '20204' || err == 20204) {
                    __WEBPACK_IMPORTED_MODULE_0_assets_js_appp_js__["a" /* app */].setState(null);
                    mui.openWindow({
                        url: 'login.html',
                        id: 'login.html',
                        preload: true,
    ...
    mui('.yz').on('tap', '.mui-btn', function (e) {
        if (accountBox.value) {
            ...
            if (isOpen) {
                ...
                __WEBPACK_IMPORTED_MODULE_0_assets_js_appp_js__["a" /* app */].getverificationCode(accountBox.value, function (err) {
                    if (err) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', [_c('header', {
    ...
    staticClass: "mui-btn mui-btn-danger yzm",
    attrs: {
      "type": "button",
      "id": "code"
    }
    ...
    staticClass: "mui-input-row mui-checkbox mui-left"
  }, [_c('label', [_vm._v("阅读并同意 ")]), _vm._v(" "), _c('a', {
    staticClass: "yh"
  }, [_vm._v("用户协议")]), _vm._v(" "), _c('input', {
    attrs: {
      "name": "checkbox",
      "value": "Item 1",
      "type": "checkbox",
