...
.mui-navbar .mui-bar {
    position: absolute;
    background: url(../../assets/img/titlebg_01.jpg) no-repeat left top;
    background-size: 100% auto;
    text-align: center;
    color: #ffffff;
}

.mui-navbar .mui-title {
    color: #ffffff;
}
...
.mui-table-view-cell>a[btn].mui-active {
...
.mui-segmented-control1.mui-segmented-control-vertical1 {
    border-collapse: collapse;
    border-width: 0;
    border-radius: 0
}

.mui-segmented-control1.mui-segmented-control-vertical1 .mui-control-item1 {
    display: block;
...
.mui-segmented-control1 .mui-control-item1 {
    ...
    color: #fc3e3e;
    border-color: #fc3e3e;
    border-left: 1px solid #fc3e3e
}

.mui-segmented-control1 .mui-control-item:first-child {
    border-left-width: 0
}

.mui-segmented-control1 .mui-control-item1.mui-active {
    color: #fff;
...
.mui-control-content1.active {
    display: block;
}

.face_con {
    overflow: hidden;
    background: url(../../assets/img/setting_02.jpg) no-repeat;
    background-size: 100%;
    /*margin-bottom: 15px;*/
}
...
#face_box {
    width: 100px;
    height: 100px;
    background: url(../../assets/img/setting_03.jpg) no-repeat center center #ffffff;
...
#showEdit {
    background: url(../../assets/img/heitou_07.png);
    width: 100%;
    height: 100%;
    position: fixed;
    top: 0;
...
.mui-input-group label.iconuser {
    background: url(../../assets/img/login_icon_03.png) no-repeat 15px center;
    background-size: auto 60%;
}

.mui-input-group label.iconpassword {
    background: url(../../assets/img/login_icon_07.png) no-repeat 17px center;
...
.mui-input-group .mui-input-row {
    width: 100%;
    margin: 0 auto;
    /*background: url(../../assets/img/baitou_03.png);*/
    /*border-radius: 35px;
...
.text_show {
    ...
    width: 67%;
    color: #c3c3c3;
    background: url(../../assets/img/arrow_03.jpg) 95% center no-repeat;
...
.mui-checkbox span.dota {
    background: url(../../assets/img/iconall_05.png) no-repeat;
    background-size: auto 100%;
}

.mui-checkbox span.lol {
    background: url(../../assets/img/iconall_03.png) no-repeat;
    background-size: auto 100%;
}

.mui-checkbox span.fengbao {
    background: url(../../assets/img/iconall_09.png) no-repeat;
    background-size: auto 100%;
}

.mui-checkbox span.csgo {
    background: url(../../assets/img/iconall_07.png) no-repeat;
    background-size: auto 100%;
}
