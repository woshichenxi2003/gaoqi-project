                            ...
                            <ul class="mui-table-view">
                                <li class="team_box">
                                    ...
                                    <div class="team_btnbox">
                                        ...
                                        <button type="button" class="mui-btn mui-btn-green-tongyi">拒绝邀请</button>
                        ...
                        <div class="mui-scroll">
                            <ul class="mui-table-view">
                                <li class="msg_box">
                                    ...
                                    <div class="msg_ifno">
                                        <h4 class="mui-ellipsis">Mesut Ozil1</h4>
                                        <p class="mui-ellipsis">小伙伴们！搞起来啊！快来啊搞起来啊！快来啊</p>
                                    </div>
...
.mui-btn.mui-btn-green-tongyi {
    color: #fff;
    border: 1px solid #fc4e3e;
    background-color: #fc4e3e;
...
.mui-btn.mui-btn-green-tongyi.mui-active:enabled,
.mui-btn.mui-btn-green-tongyi:enabled:active {
    color: #fff;
