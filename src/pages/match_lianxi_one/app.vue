<template>
    <span>
        ...
        <header class="mui-bar mui-bar-nav">
			...
			<a class="mui-icon-extra mui-icon-extra-share mui-pull-right" style="margin-top: 10px; margin-right: 20px;"></a>
			<h1 class="mui-title">单场比赛</h1>
		</header>
		<footer class="mui-bar mui-bar-footer .lianxi_one" id="join_btn">
		    <button type="button" class="mui-btn mui-btn-hong-creat">
		    	<div class="btn_title blink">放 弃 比 赛</div>
		    </button>
		    <button type="button" class="mui-btn mui-btn-hong-creat">
		    	<div class="btn_title blink">提 交 赛 果</div>
		    	<div class="ts">
		...
		<div class="mui-content">
		    <div class="con">
		    	<div class="video">
					<img src="../../assets/img/zhibo_02.jpg"/>
				</div>
				<div class="vs_box">
		    		<div class="vs_left">
		    			<div class="team_logo">
		    	...
		    	<div class="ob_con">
					...
					<div class="ob_msg1">
						<p class="mui-ellipsis">本场OB:</p>
						<p class="mui-ellipsis">KJDS-SNHD</p>
					</div>
				</div>
				<div class="chat_box">
					<div class="mui-content">
				...
				<div class="mui-card">
					<ul class="mui-table-view">
						<li class="mui-table-view-cell mui-collapse mui-active">
							<a class="mui-navigate-right" href="#">赛事简介</a>
